...
String st="accepted";
String sql = "update user set status='"+st+"' where userid='"+name+"' and emailid='"+email+"'";
...
message.setSubject("Secure file sharing");
message.setText("Hi.."+name+"\n your request is accepted By  admin ..Please Login");
