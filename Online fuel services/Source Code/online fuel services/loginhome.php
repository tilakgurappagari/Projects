    ...
    <div id="navigation">
      ...
      <ul>
        ...
        <li><a href="lcontact.php">Contact</a></li>
		        <li><a href="userup.php">Edit Info</a></li>
    ...
    <div id="content">
      ...
      <div id="slider" class="box">
        <div id="slider-holder">
          <ul>
            <li><a href="#"><img src="css/images/petrol.jpg" alt="" /></a></li>
            <li><a href="#"><img src="css/images/diesel.jpg" alt="" /></a></li>
            <li><a href="#"><img src="css/images/spetrol.png" alt="" /></a></li>
            <li><a href="#"><img src="css/images/oils.jpg" alt="" /></a></li>
          </ul>
        </div>
     ...
     <!-- Categories -->
      <div class="box categories">
        ...
        <div class="box-content">
          <ul>
            <li><a href="lpetrol.php">Petrol</a></li><br/><br/>
           <li><a href="ldiesel.php">Diesel</a></li><br/><br/>
            <li><a href="llpg.php">LPG</a></li><br/><br/>
            <li><a href="loils.php">Oils</a></li><br/><br/>
           </ul>
         </div>
      </div>
      <!-- End Categories -->
