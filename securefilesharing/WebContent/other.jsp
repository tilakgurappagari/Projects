                ...
                <ul>
                    ...
                    <li class="current_page_item"><a href="report.jsp">Report</a></li>
                     <li><a href="downloadother.jsp">Downloadsharedfiles</a></li>
                       <li><a href="vfr.jsp">ViewFileRequest</a></li>
                            ...
                            <div class="post">
                                ...
                                <div class="entry">
                                    ...
                                    <table border="1" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                        <h3>note: If Status is fail u can't download </h3>
                                            <th>FileName</th>
                                             <th>Status</th>
                                            <th>Locatione</th>
                                            <th>Ip</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="req.jsp?ow=<%=rs.getString(1)%>&filename=<%=rs.getString(2)%>&fk=<%=rs.getString(9)%>">Request</a></td>
