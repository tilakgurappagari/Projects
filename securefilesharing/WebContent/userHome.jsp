                            ...
                            <div class="post">                               
                                ...
                                <div class="entry">
                                    ...
                                    <table border="1" width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        PreparedStatement pst = con.prepareStatement("select * from user where userid='"+session.getAttribute("userid")+"'");
                                        ResultSet rsw=pst.executeQuery();
                                        if(rsw.next()){
                                        	String e=rsw.getString(5);
