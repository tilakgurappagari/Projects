            ...
            <div id="menu">
                <ul>
                    ...
                    <li ><a href="viewUser.jsp">Member Details</a></li>
                                        <li class="current_page_item"><a href="userrequest.jsp">UserRequest</a></li>                    
                                ...
                                <div class="entry">
                                    ...
                                    <table border="1" width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="mailsend.jsp?email=<%=rs.getString("emailid")%>&un=<%=rs.getString("userid")%>">Accept</a></td>
                                        </tr>
